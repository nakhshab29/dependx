  ...
  "rounded-xl border text-card-foreground transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        critical: "bg-card border-critical/30 shadow-glow-critical",
        interactive: "bg-card border-border shadow-card hover:border-primary/50 hover:shadow-glow-primary cursor-pointer",
      },
    },
    defaultVariants: {
      variant: "default",
